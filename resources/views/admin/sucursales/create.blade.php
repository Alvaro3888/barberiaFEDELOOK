...
<div class="container mt-4">
    <h2 class="mb-4 text-primary text-center">Crear Sucursal</h2>
    ...
    <form action="{{ route('admin.sucursales.store') }}" method="POST" class="card p-4 shadow-sm">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" name="horarios" id="horarios" value="{{ old('horarios') }}" class="form-control">
        </div>
