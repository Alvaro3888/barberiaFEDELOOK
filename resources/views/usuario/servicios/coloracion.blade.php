...
<div class="container mt-4">
    <h2 class="mb-4 text-center text-danger">Todas las Coloraciones</h2>
    <div class="row">
        ...
        <div class="col-md-3 mb-4">
            <div class="card shadow-sm">
                ...
                @else
                    <img src="{{ asset('images/color1.webp') }}" class="card-img-top" alt="{{ $servicio->nombre }}" style="height:220px; object-fit:cover;">
                @endif
        ...
        @empty
        <p class="text-center">No hay coloraciones disponibles.</p>
        @endforelse
    </div>
</div>
@endsection
